...
* `zmq-client-single.out`:
  ...
  Sending 2000000 items takes 6749ms (296308 per sec or 3.4us per record)
  ```
* `zmq-client-multiple.out`:
  ```
  Opening connection to tcp://localhost:4242...
  Filling 2000000 items with random data...
  Serializing 2000000 items for ZeroMQ...
  Sending 2000000 items (in 100000 batches) over ZeroMQ...
  Sending 2000000 items takes 4682ms (427118 per sec or 2.3us per record)
  ```

* `zmq-server-single.out`/`zmq-server-multiple.out`:
  ```
  Binding to tcp://*:4242...
  Id: 1316074830
  Name: Dave
