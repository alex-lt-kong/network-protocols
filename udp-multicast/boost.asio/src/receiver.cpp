...
int main(const int argc, char *argv[]) {
    try {
        ...
        options.add_options()
          ...
          ("i,interface", "Bind to this interface for receiving multicast packets", cxxopts::value<std::string>())
        ...
        socket.set_option(
                boost::asio::ip::multicast::join_group(boost::asio::ip::make_address(multicast_address).to_v4(),
